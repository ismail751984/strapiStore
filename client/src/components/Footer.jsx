  ...
  return (
    ...
    <div className="row px-xl-5 pt-5">
        <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="m-0 display-5 font-weight-semi-bold"><span className="text-primary font-weight-bold border px-3 mr-1">ډيوه</span> انلائن </p>
            </a>
        ...
        <div className="col-lg-8 col-md-12">
            <div className="row">
                ...
                <div className="col-md-8 mb-5">
                    <h5 className="font-weight-bold text-dark mb-8">Newsletter</h5>
                    <form action="">
